# Lenscrafters.com N52W Demand Forecast
...
sql <- paste("DELETE ecomm.fcst_locked_isaiah WHERE yr_wk_lock = ", x ," AND brand = 'LC'", sep = "")
...
write_csv(fcst_sku_loc, "lc-fcst-sku-loc.csv")
write_csv(fcst, "lc-fcst-flat.csv")
